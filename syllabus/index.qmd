...
- **Proofgrammers Skill-Checks**: Completed during a Tuesday laboratory session,
these skill-checks are online, cumulative assessments covering all prior
technical material from the prior course sessions, as outlined on the [course
schedule](../schedule/index.qmd). Unless prior arrangements are made with the
instructor, all students should use their computer to take these skill-checks on
...
three executable examinations, each skill-check is an executable assessment that
students complete through the use of GitHub, a text editor like VS Code, and the
...
explain how they used them to complete the skill-check.

- **Proofgrammers Knowledge-Checks**: Completed individually during a Thursday
laboratory session, these knowledge-checks are in-person, cumulative assessments
covering all prior material from the prior course sessions, as
...
part of the team-based proofgrammer presentations. Students may not use any
...
- **Proofgrammers Charettes**: Completed in the second half of a Thursday
...
charette session, students will first pose questions about the technical and
mathematical course less-well-understood content that was presented during the
prior laboratory sessions. After posing a series of new questions and revising
past questions that have not yet been answered, students will work in teams to
answers chosen questions. Once the class members approve the answer for a
question, the team members who correctly answered the question will record their
contact information and a brief answer in the charette tracking system.

- **Executable Examinations**: The final examination is an online, executable,
...
Each cumulative executable examination will complete by a student through the
use of GitHub, a text editor like VS Code, and the Python programming tools
...
- **Proofgrammer Presentations**: Completed by assigned teams of students during
a Thursday laboratory session, these in-person presentations are on technical
topics assigned by the course instructor. Students will use all the tools setup
on their laptops to implement a Python program that solves the stated problem
and/or completes the required proof, ensuring that it is built as a stand-alone
script with its dependencies and virtual environments managed by
[`uv`](https://docs.astral.sh/uv/). Along with the three proofgrammer
presentations given per module, assigned teams of students will also complete
two retrospective presentations that review the content covered during the first
two modules of the course. For each team assigned to give a proofgrammer
presentation, there will be another assigned team of students that is
...
- **theoretical machines Tool-Building Projects**: Completed individually in
three stages that span the entire academic semester, these projects enable
students to build and evaluate a complete theoretical machines pipeline in the
...
- **theoretical machines Skill-Checks**: Grade automatically reported at end of
...
- **theoretical machines Knowledge-Checks**: Grade reported at conclusion of a
...
- **theoretical machines Presentations**: There are two types of these
team-based presentations: theoretical machines Concept Overviews (DECO) and
theoretical machines Project Critiques (DEPC). A grade is reported one-week
...
- **theoretical machines Tool-Building Projects**: There are two types of grades
...
work on the theoretical machines tools, a student will receive a total of
...
- **Module One**: 
  - **Topic**: theoretical machines Foundations
...
- **Module Two**:
  - **Topic**: theoretical machines Building Blocks
...
- **Module Three**:
  - **Topic**: Advanced theoretical machines
...
- **theoretical machines Skill-Checks**:
...
- **theoretical machines Knowledge-Checks**:
  - **Knowledge-Check One**:
...
- {{< iconify fa6-solid lightbulb size=18px >}} **Monday**:
  - theoretical machines deep-dive presentations by the course instructor
...
- {{< iconify fa6-solid people-line size=18px >}} **Wednesday**:
  - theoretical machines presentations and evaluations by student teams
  - As outlined on the course schedule, teams give two types of presentations:
     - theoretical machines Concept Overviews (DECO)
     - theoretical machines Project Critiques (DEPC)
...
- {{< iconify fa6-solid gears size=18px >}} **Wednesday Laboratory**:
  - Across five weeks, complete tasks for theoretical machines tool-building
  projects
...
- {{< iconify fa6-solid gears size=18px >}} **Friday**:
  - Use GitHub, VS Code, and Python to complete theoretical machines
  skill-checks
  - Complete in-person theoretical machines knowledge-checks in instructor's
  office
...
Classroom, and/or the [theoretical machines Discord](https://discord.gg/5HdxuqjUvK).
...
re-take either a theoretical machines skill-check or knowledge-check. Students
...
theoretical machines tool-building project. Outside of using these four tokens
...
[theoretical machines Discord Server](https://discord.gg/5HdxuqjUvK); please
...
distinct Discord servers for all course discussions. The [theoretical machines
...
Although we will primarily use the [theoretical machines Discord
...
#### Effective theoretical machines
...
in-person or online discussion, about any theoretical machines content,
...
and the members of the [theoretical machines Discord
