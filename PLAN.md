...
`slides/weektwelve/index.qmd`. You can add to this file! Please note that I have
already created the correct title and added some learning objective slides that
I want you to keep in this slide deck.
...
creating slides for _week twelve_ of the course in the `index.qmd` file that is
in that directory but for _chapter eleven_ of the book.
