...
Computed"](https://whatcanbecomputed.com/) and grasp SISO
programming
...
def invalidReturn1(inString: str) -> int:
...
- We will focus on SISO programs as focus of theoretical analysis
...
- This creates an endless cycle: when `number` reaches 100, it jumps back to
101, so it never reaches 0.
...
- **Question**: Would it be possible to automatically detect this behavior? Why
  or why not? Can you justify your answer?
