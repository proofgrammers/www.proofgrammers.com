...
Multiple Sequence Alignment is an example of an intractable problem. On a small scale, it seems manageable, but as the number of sequences grows, the computations quickly become impractical.
