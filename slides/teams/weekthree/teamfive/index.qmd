...
::: {.fragment}
  - **Static Analyzer:** A tool that examines source code without running it, searching for bugs, unreachable code, or infinite loops. 
    - Vulture
    - Bandit
  - **How They Work:** Use pattern matching and heuristics to flag suspicious code (e.g., `while True`, loops with constant conditions).
  - **Limitations:** Can only detect obvious cases; cannot guarantee detection for all infinite loops.
