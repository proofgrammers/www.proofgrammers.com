...
- There are an infinte number of ways to structure a program that will get the same results so it's unfeasible to make workarounds for structures being different but equivalent.
