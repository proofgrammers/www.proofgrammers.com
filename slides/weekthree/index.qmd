...
{{< iconify fa6-solid exclamation-triangle >}} **Contradiction**: `notYesOnSelf`
returns "yes" if and only if it returns "no"! No program can have this
property, so `notYesOnSelf` cannot exist.
