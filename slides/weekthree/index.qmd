...
{{< iconify fa6-solid bullhorn >}} **Contradiction**: `notYesOnSelf` returns
"yes" if and only if it returns "no"! No program can have this property, so
`notYesOnSelf` cannot exist. This is amazing, right?
