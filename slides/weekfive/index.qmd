---
title: "Turing Machines: The Simplest Computers"
description: "Exploring the mathematical foundations of computation"
date: "2025-09-22"
date-format: long
...
# What is the simplest possible computer? Can we define one?

## Meeting the Turing machine

::: {.incremental style="margin-top: -0.5em; font-size: 0.825em;"} 

- {{< iconify fa6-solid lightbulb >}} **What is a Turing machine?**
...
{{< iconify fa6-solid lightbulb >}} A Turing machine is amazingly simple: just 
tape, head, and state control. Yet it can compute anything that any computer can!
