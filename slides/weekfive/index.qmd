...
- {{< iconify fa6-solid code >}} **Implementation**: Use marker symbol `z` for processed symbols
...
- {{< iconify fa6-solid code >}} **Compact notation in textbook**:
    ...
    - `zTA` means "any symbol from {z, T, A}"
    - `zTAC` means "any symbol from {z, T, A, C}"  
    - `zTAG` means "any symbol from {z, T, A, G}"
