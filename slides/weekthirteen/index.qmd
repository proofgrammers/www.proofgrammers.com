...
- {{< iconify fa6-solid lightbulb >}} **Hint $H$**: `"a,b,c"`, which is the
actual Hamilton cycle, hooray!
...
time!
- **Without hint, need exponential time as there are $n!$ possible cycles to
check**
...
containing problems whose positive instances can be correctly verified in
polynomial time
