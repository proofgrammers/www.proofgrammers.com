...
::: {.incremental style="margin-top: -0.15em; font-size: 0.81em;"}
...
::: {.incremental style="margin-top: -0.15em; font-size: 0.78em;"}
...
- {{< iconify fa6-solid gear >}} **Complement** ($\overline{L}$)
  ...
  - **Example**: If $L = \{a, b\}$ over $\{a, b\}$, then $\overline{L} = \{\epsilon, aa, ab, ba, bb, aaa, ...\}$
...
- {{< iconify fa6-solid gear >}} **Concatenation** ($L_1 L_2$ or $L_1 \cdot L_2$)
  - Contains all strings formed by concatenating a string from $L_1$ with a string from $L_2$
  - **Example**: $\{a, ab\} \cdot \{b, c\} = \{ab, ac, abb, abc\}$
