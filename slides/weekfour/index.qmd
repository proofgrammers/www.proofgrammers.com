...
programs can solve the same problem in fundamentally different ways!
...
- Each function should produce same result!
...
A program doesn't truly solve a problem unless it terminates on *all* inputs and
