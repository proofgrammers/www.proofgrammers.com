...
- {{< iconify fa6-solid lightbulb >}} **Problems vs programs**
    ...
    - Some programs may be correct, others incorrect
...
Programs solve problems - but different programs can solve the same problem in 
...
::: {.fragment .fade .boxed-content style="font-size: 1.0em;"}
A program doesn't truly solve a problem unless it terminates on *all* inputs 
...
- {{< iconify fa6-solid gear >}} **Alphabet $\Sigma$**
  ...
  - $\Sigma^*$ = all possible strings over alphabet $\Sigma$
...
## Formal definition of computational problem
