...
description: "Grasp programs that can run all programs"
date: "2025-10-06"
date-format: long
...
- Why is this possible? What are the benefits and limitations?
...
- {{< iconify fa6-solid gears >}} **Three-step process**
    - **Step One: Define**: `exec()` creates function in memory
    - **Step Two: Extract**: Get reference to the newly defined function  
    - **Step Three: Execute**: Call function with provided input
    - Wow, the result matches program behavior if defined as a function!
