...
- {{< iconify fa6-solid lightbulb .animate__pulse >}} **What is theory of computation?**
...
- {{< iconify fa6-solid lightbulb .animate__pulse >}} **Why is it important?**
...
- {{< iconify fa6-solid lightbulb .animate__bounce >}} [**Use programming to explore what can be computed!**]{.animate__bounce .animate__slow}
...
- [**Welcome to the proofgrammer team! How exciting!**]{.animate__tada}
...
- {{< iconify fa6-solid lightbulb .animate__flash >}} [**Differences in tractable, intractable, and uncomputable?**]{.animate__pulse}
...
# [Don't assume it is possible to implement every Python program! Start to think like a proofgrammer!]{.animate__shakeX}
...
::: {.fragment .fade .boxed-content .animate__slideInUp style="margin-top: 0.25em; font-size: 0.9em;"}
...
::: {.fragment .fade .boxed-content .animate__slideInUp style="margin-top: -0.1em; font-size: 0.8em;"}
...
- {{< iconify fa6-solid rocket .animate__bounce >}} [**Have these setup by the end of this week**!]{.animate__bounce .animate__slow}
...
- {{< iconify fa6-solid rocket .animate__pulse >}} [**Get ready for an exciting journey into theoretical machines!**]{.animate__pulse .animate__slow}
- {{< iconify fa6-solid lightbulb .animate__flash >}} [**If you are having trouble, publicly ask for help on Discord!**]{.animate__pulse}
