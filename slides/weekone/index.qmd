...
{{< iconify fa6-solid microscope >}} How do we *prove* computational limits using code? How do we *implement* theoretical machines? How do we *verify* complexity results?
...
{{< iconify fa6-solid microscope >}} How do we *implement* theoretical concepts in code? How do we *verify* computational results? How do we *document* our proofs effectively?
...
code](https://github.com/johnmaccormick/wcbc-programs) and [theory
implementations](https://github.com/topics/theory-of-computation)
...
```python
# Essential VS Code extensions for proofgrammers
extensions = [
...
- {{< iconify fa6-solid lightbulb >}} **Why Quarto for proofgrammers?** Create reproducible documents with mathematical proofs and Python implementations!
