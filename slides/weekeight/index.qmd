...
transforms the output of any program to "yes" if standard output of "GAGA" or
"no" otherwise
...
::: {.fragment .boxed-content style="margin-top: -0.25em; font-size: 0.75em;"}
...
- {{< iconify fa6-solid lightbulb >}} Can we prove that `haltOnString` is uncomputable?
