...
per conversion and/or processing
- This logarithmic factor multiplies the quadratic loop structure, yielding
$O(n² log n)$ total complexity!
- **Not sufficient to _only_ look at the loop structure!**
...
- **With that in mind, are the other complexity classes**?
